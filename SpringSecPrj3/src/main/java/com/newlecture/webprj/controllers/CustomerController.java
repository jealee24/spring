...
public class CustomerController {
	...
	public String noticeReg(Notice n, HttpServletRequest request, Principal principal/*, String title, String content*/) throws ClassNotFoundException, SQLException, IOException {
